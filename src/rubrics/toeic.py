...
READ_ALOUD = QuestionType(
    ...
    guidance=(
        ...
        "insertions = thêm từ) là bằng chứng KHÁCH QUAN quan trọng. Từ bị bỏ "
        "(deletions) nghiêm trọng hơn vì là phần đáng lẽ phải đọc. Chỉ chấm "
        "Pronunciation và Intonation & stress; KHÔNG chấm nội dung vì nội dung "
        "đã cho sẵn."
    ),
)
